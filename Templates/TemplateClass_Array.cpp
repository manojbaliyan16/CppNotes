// With this example we will come to know, What is the use of Template Class 
// Here with single code I can create an Ineger array and and Double Array due to Template class 
#include <iostream>
#include <assert.h>
